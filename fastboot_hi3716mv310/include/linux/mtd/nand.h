...
/* Status bits */
#ifndef CONFIG_SPI_NAND_SUPPORT
...
#define NAND_STATUS_PFAIL	NAND_STATUS_FAIL
#define NAND_STATUS_EFAIL	NAND_STATUS_FAIL
#else
#define NAND_STATUS_PFAIL	0x08
#define NAND_STATUS_EFAIL	0x04
/* for SPI_NAND, status register bit0: 1: busy, 0: ready */
#define NAND_STATUS_READY	0x01 
#define NAND_STATUS_WP		(0x07 << 3)
#endif
/*
