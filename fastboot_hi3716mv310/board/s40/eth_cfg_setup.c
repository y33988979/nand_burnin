...
void eth_config_init(void)
{
	...
	if ((_HI3719M_V100 == get_chipid()) || (_HI3718M_V100 == get_chipid())) {
		/* There's only one eth port for hi3719mv100. */
